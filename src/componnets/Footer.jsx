...
function Footer() {
  ...
  const handleToggle = () => setIsInputVisible((prev) => !prev);
      ...
      <div className="flex flex-col w-full max-w-[1171px]">
        <div className="flex flex-col md:flex-row justify-end items-center gap-5 md:gap-7">
          <div className="flex flex-col sm:flex-row items-center gap-4">
            <div className="flex gap-4 items-center bg-white rounded-md px-4 py-1.5 mt-2 sm:mt-0">
              {isInputVisible ? (
                <input
                  type="email"
              ...
              <div
                ...
                onClick={isInputVisible ? handleSubscribe : handleToggle}
              >
                Subscribe
              </div>
            </div>
